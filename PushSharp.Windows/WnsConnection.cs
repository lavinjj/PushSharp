...
namespace PushSharp.Windows
{
    ...
    public class WnsServiceConnection : IServiceConnection<WnsNotification>
    {
        ...
        WnsNotificationStatus ParseStatus(HttpResponseMessage resp, WnsNotification notification)
        {
            ...
            if (wnsNotificationStatus.Equals("received", StringComparison.CurrentCultureIgnoreCase))
                result.NotificationStatus = WnsNotificationSendStatus.Received;
            else if (wnsNotificationStatus.Equals("dropped", StringComparison.CurrentCultureIgnoreCase))
            ...
            if (wnsDeviceConnectionStatus.Equals("connected", StringComparison.CurrentCultureIgnoreCase))
                result.DeviceConnectionStatus = WnsDeviceConnectionStatus.Connected;
            else if (wnsDeviceConnectionStatus.Equals("tempdisconnected", StringComparison.CurrentCultureIgnoreCase))
