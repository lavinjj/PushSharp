...
namespace PushSharp.Blackberry
{
    ...
    {   
        ...
        public void OverrideSendUrl(string url)
        {
            ...
            {
                if (url.EndsWith("pushapi.na.blackberry.com", StringComparison.CurrentCultureIgnoreCase) ||
                    url.EndsWith("pushapi.eval.blackberry.com", StringComparison.CurrentCultureIgnoreCase))
